<?php
// /heavens/akun_mahasiswa/index.php
...
$nama     = $_SESSION['user_nama'] ?? 'Praktikan';
...
<head>
<meta charset="UTF-8">
<title>Halaman Praktikan - <?= e($nama); ?></title>
...
<div class="container">
    <div class="header shadow-sm">
        <h3 class="mb-2">Halaman Praktikan</h3>
    ...
    <div class="row g-3 justify-content-center">
        <div class="col-6 col-md-4">
            <a href="/heavens/akun_mahasiswa/buat_kode_presensi.php" class="text-dark">
        ...
        <div class="col-6 col-md-4">
            <a href="/heavens/akun_mahasiswa/penugasan.php" class="text-dark">
        ...
        <div class="col-6 col-md-4">
            <a href="/heavens/akun_mahasiswa/logout.php" class="text-dark">
                <div class="card p-3 card-menu text-center">
