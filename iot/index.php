...
<body>
  ...
  <div class="container py-4">
    ...
    <div class="hero mb-4">
      ...
      <p class="mb-0">Layanan resmi untuk mahasiswa dalam pengembangan Internet of Things (IoT), sistem monitoring,
        kontrol jarak jauh, ESP8266/ESP32 dan NodeMCU.</p>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-6">
        <div class="price-box">
          ...
          <a href="#" class="btn btn-primary btn-sm disabled">Coming Soon</a>
          <a href="/heavens/iot/sensor/" class="btn btn-primary btn-sm">
            🔧 Daftar Sensor IoT
          </a>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="price-box">
          ...
          <p>Melayani konsultasi project IoT seperti monitoring suhu, kelembaban, pakan otomatis, smart home, sistem
            pendeteksi, dan sensor lainnya.</p>
          <ul>
